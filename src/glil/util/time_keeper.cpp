#include <glil/util/time_keeper.hpp>
...
void TimeKeeper::process(const glil::RawPoints::Ptr& points) {
...
void TimeKeeper::replace_points_stamp(const glil::RawPoints::Ptr& points) {
